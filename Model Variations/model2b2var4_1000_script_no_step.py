...
lr = 0.0001
patience = 10
path = 'var4l2_no_step_1000'
description = "Model test: Variation 4 now with weight decay (1e-5), no learning rate scheduler and much higher epochs"
...
train_transform = transforms.Compose([
    ...
    v2.ColorJitter(brightness=0.35, contrast=0.3, saturation=0.3, hue=0.1),
...
axAcc.plot(train_accuracies, label='Training')
axAcc.plot(val_accuracies, label='Validation')
