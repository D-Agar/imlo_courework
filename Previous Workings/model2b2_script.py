...
path = 'model2b'
model = "2b"
description = "Same model, change data augmentation, 0.3 for everything except hue (0.2)"

print(f"Model: {model}, Epochs: {epochs}, Batch size: {batch_size}, Optimiser: Adam, lr={lr}")
print(description)
